...
declare -A patch_list=(
    ...
    ["418.152.00"]='s/\x00\x00\x00\x84\xc0\x0f\x84\x0f\xfd\xff\xff/\x00\x00\x00\x84\xc0\x90\x90\x90\x90\x90\x90/g'
    ["418.181.07"]='s/\x00\x00\x00\x84\xc0\x0f\x84\x0f\xfd\xff\xff/\x00\x00\x00\x84\xc0\x90\x90\x90\x90\x90\x90/g'
...
declare -A object_list=(
    ...
    ["418.152.00"]='libnvcuvid.so'
    ["418.181.07"]='libnvcuvid.so'
